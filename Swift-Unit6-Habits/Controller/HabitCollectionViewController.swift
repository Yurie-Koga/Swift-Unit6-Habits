...
class HabitCollectionViewController: UICollectionViewController {
    ...
    /* Strictly unnecessary: just to explicit reference to models */
    struct Model {
    ...
    func configureCell(_ cell: PrimarySecondaryTextCollectionViewCell, withItem: ViewModel.Item) {
        cell.primaryTextLabel.text = withItem.habit.name
    }
    ...
    func createDataSource() -> DataSourceType {
        ...
        dataSource.supplementaryViewProvider = { (collectionView, kind, indexPath) in
            let header = collectionView.dequeueReusableSupplementaryView(ofKind: self.sectionHeaderKind, withReuseIdentifier: self.sectionHeaderIdentifier, for: indexPath) as! NamedSectionHeaderView
